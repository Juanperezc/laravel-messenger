...
class TestCase extends Orchestra
{
    ...
    {
        $app['config']->set('messenger.message_model', 'Juan\Messenger\Models\Message');
        $app['config']->set('messenger.participant_model', 'Juan\Messenger\Models\Participant');
        $app['config']->set('messenger.thread_model', 'Juan\Messenger\Models\Thread');
    }
